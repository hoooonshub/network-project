#############################################################################
# Makefile for building: one-card.app/Contents/MacOS/one-card
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  one-card.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile one-card.pro
#############################################################################
...
DEFINES       = -DQT_NO_DEBUG -DQT_QUICKCONTROLS2_LIB -DQT_QUICK_LIB -DQT_OPENGL_LIB -DQT_GUI_LIB -DQT_QMLMETA_LIB -DQT_QMLMODELS_LIB -DQT_QMLWORKERSCRIPT_LIB -DQT_QML_LIB -DQT_QMLINTEGRATION_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -I/opt/homebrew/lib/QtQuickControls2.framework/Headers -I/opt/homebrew/lib/QtQuick.framework/Headers -I/opt/homebrew/lib/QtOpenGL.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtQmlMeta.framework/Headers -I/opt/homebrew/lib/QtQmlModels.framework/Headers -I/opt/homebrew/lib/QtQmlWorkerScript.framework/Headers -I/opt/homebrew/lib/QtQml.framework/Headers -I/opt/homebrew/include -I/opt/homebrew/include/QtQmlIntegration -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = one-card1.0.0
DISTDIR = /Users/jung-yonghun/Documents/networkprogramming/term_project/one-card/.tmp/one-card1.0.0
...
SOURCES       = client/client.cpp moc_GameClient.cpp
OBJECTS       = client.o \
		moc_GameClient.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		one-card.pro client/GameClient.h client/client.cpp
QMAKE_TARGET  = one-card
DESTDIR       = 
TARGET        = one-card.app/Contents/MacOS/one-card

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.4
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/jung-yonghun/Documents/networkprogramming/term_project/one-card/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/jung-yonghun/Documents/networkprogramming/term_project/one-card/one-card.pro
...
one-card.app/Contents/MacOS/one-card:  $(OBJECTS)  
	@test -d one-card.app/Contents/MacOS/ || mkdir -p one-card.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: one-card.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
		...
		/opt/homebrew/share/qt/mkspecs/features/lex.prf \
		one-card.pro \
		/opt/homebrew/lib/QtQuickControls2.framework/Resources/QtQuickControls2.prl \
...
one-card.app/Contents/PkgInfo: 
	@test -d one-card.app/Contents || mkdir -p one-card.app/Contents
	@$(DEL_FILE) one-card.app/Contents/PkgInfo
	@echo "APPL????" > one-card.app/Contents/PkgInfo
one-card.app/Contents/Info.plist: 
	@test -d one-card.app/Contents || mkdir -p one-card.app/Contents
	@$(DEL_FILE) one-card.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.one-card,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.one-card,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,one-card,g" -e "s,@LIBRARY@,one-card,g" -e "s,\$${EXECUTABLE_NAME},one-card,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >one-card.app/Contents/Info.plist

all: Makefile \
		one-card.app/Contents/PkgInfo \
		one-card.app/Contents/Info.plist one-card.app/Contents/MacOS/one-card
...
distdir: FORCE
	...
	$(COPY_FILE) --parents client/GameClient.h $(DISTDIR)/
	$(COPY_FILE) --parents client/client.cpp client/GameClient.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_GameClient.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_GameClient.cpp
moc_GameClient.cpp: client/GameClient.h \
		Common.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/jung-yonghun/Documents/networkprogramming/term_project/one-card/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/jung-yonghun/Documents/networkprogramming/term_project/one-card -I/Users/jung-yonghun/Documents/networkprogramming/term_project/one-card -I/opt/homebrew/lib/QtQuickControls2.framework/Headers -I/opt/homebrew/lib/QtQuick.framework/Headers -I/opt/homebrew/lib/QtOpenGL.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtQmlMeta.framework/Headers -I/opt/homebrew/lib/QtQmlModels.framework/Headers -I/opt/homebrew/lib/QtQmlWorkerScript.framework/Headers -I/opt/homebrew/lib/QtQml.framework/Headers -I/opt/homebrew/include -I/opt/homebrew/include/QtQmlIntegration -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib client/GameClient.h -o moc_GameClient.cpp
...
client.o: client/client.cpp Common.h \
